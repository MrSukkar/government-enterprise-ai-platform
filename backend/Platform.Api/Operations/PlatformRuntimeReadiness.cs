...
internal sealed class PlatformRuntimeReadiness
{
    ...
    internal static PlatformRuntimeReadiness Inspect(IServiceCollection services)
    {
        ...
        var requiredDependencies = new (string Capability, Type Contract)[]
        {
            ...
            ("Sandbox-authorized Security Validation receipt reader", typeof(ISandboxSecurityValidationReceiptReader)),
            ("Sandbox Code Generation candidate reader", typeof(ISandboxCodeGenerationCandidateReader)),
            ...
            ("Later-station Authorized Security Validation receipt reader", typeof(IAuthorizedSecurityValidationReceiptReader)),
            ("Tests OPA policy gate", typeof(ITestsPolicyGate)),
            ("Tests-authorized Sandbox receipt reader", typeof(ITestsSandboxExecutionReceiptReader)),
            ("Tests-authorized Security receipt reader", typeof(ITestsSecurityValidationReceiptReader)),
            ("Tests Code Generation candidate reader", typeof(ITestsCodeGenerationCandidateReader)),
            ...
            ("Later-station Authorized Sandbox receipt reader", typeof(IAuthorizedSandboxExecutionReceiptReader)),
            ("Human Review OPA policy gate", typeof(IHumanReviewPolicyGate)),
            ("Human Review-authorized Tests receipt reader", typeof(IHumanReviewTestsReceiptReader)),
            ("Human Review-authorized Sandbox receipt reader", typeof(IHumanReviewSandboxReceiptReader)),
            ("Human Review-authorized Security receipt reader", typeof(IHumanReviewSecurityReceiptReader)),
            ("Human Review-authorized Code Generation candidate reader", typeof(IHumanReviewCandidateReader)),
            ...
            ("Git-authorized Human Review receipt reader", typeof(IGitHumanReviewReceiptReader)),
            ("Git-authorized Tests receipt reader", typeof(IGitTestsReceiptReader)),
            ("Git-authorized Code Generation candidate reader", typeof(IGitCandidateReader)),
