...
CREATE TABLE IF NOT EXISTS software_factory.sandbox_delivery_run_snapshots
(
    ...
    CONSTRAINT pk_sandbox_delivery_run PRIMARY KEY (tenant_id, run_id),
    CONSTRAINT uq_sandbox_delivery_run_evidence UNIQUE (tenant_id, evidence_reference),
    CONSTRAINT fk_sandbox_security FOREIGN KEY (tenant_id, security_validation_id)
