...
Status: **Approved through Operational Increment 15**
...
Operational Increment 06 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-03-EXISTING-ARCHITECTURE.md` and remains limited to Authorized Existing Architecture Discovery.
...
Operational Increment 09 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-06-CODE-GENERATION.md` and remains limited to Governed Code Generation Candidate.

Operational Increment 10 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-07-STATIC-VALIDATION.md` and remains limited to Governed Static Validation.

Operational Increment 11 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-08-SECURITY-VALIDATION.md` and remains limited to Governed Security Validation.

Operational Increment 12 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-09-SANDBOX.md` and remains limited to Governed Security Sandbox Execution.
...
Operational Increment 15 is governed by the approved amendment `docs/change-control/CR-001-AMENDMENT-12-GIT.md` and remains limited to Governed Git Source Commit.
...
- Increment: 09 — Governed Code Generation Candidate, as bounded by Amendment 06.
- Increment: 10 — Governed Static Validation, as bounded by Amendment 07.
...
- Increment: 15 — Governed Git Source Commit, as bounded by Amendment 12.
